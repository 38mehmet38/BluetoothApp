...
public final class ItemUserBinding implements ViewBinding {
  ...
  private ItemUserBinding(@NonNull LinearLayout rootView, @NonNull ImageView ivStatus,
  ...
  public static ItemUserBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemUserBinding((LinearLayout) rootView, ivStatus, tvUserName, tvUserStatus);
    }
