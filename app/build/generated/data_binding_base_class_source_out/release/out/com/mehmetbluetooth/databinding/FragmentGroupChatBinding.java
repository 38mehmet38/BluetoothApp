...
public final class FragmentGroupChatBinding implements ViewBinding {
  ...
  private FragmentGroupChatBinding(@NonNull LinearLayout rootView, @NonNull Button btnSend,
  ...
  public static FragmentGroupChatBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentGroupChatBinding((LinearLayout) rootView, btnSend, etMessage, rvMessages);
    }
